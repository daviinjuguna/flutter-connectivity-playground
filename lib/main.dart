import 'package:connectivity_playground/di/injection.dart';
import 'package:connectivity_playground/widgets/network_dialogue.dart';
...
final _scaffold = GlobalKey<ScaffoldMessengerState>();
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocListener<NetworkBloc, NetworkState>(
        ...
        child: MaterialApp(
          scaffoldMessengerKey: _scaffold,
          navigatorKey: _nav,
          title: 'Flutter Demo',
          theme: ThemeData(
  ...
  void _show() {
    final _context = _nav.currentState?.overlay?.context;
    _isOpen = true;
    showDialog(
      context: _context!,
